...
export default function Hero() {
  ...
  const handleFlightSearch = () => {
    ...
    // Same week-long memory as the package tab, and the same reason: the flights-only search
    // is re-run across visits too. Passenger counts stay out of it for consistency with the
    // package tab, where the party belongs to paxStore and its shorter window.
    saveSearch({
      mode: 'flight',
