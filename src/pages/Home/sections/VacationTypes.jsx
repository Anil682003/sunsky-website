    ...
    <div className={styles.sectionAlt}>
      <div className={styles.section}>
        <div className={styles.header}>
          <div>
            <div className={styles.tag}>♡ Curated</div>
            <h2 className={styles.title}>Your <span className={`${styles.accent} ${styles.script}`}>favorite</span> type of vacation</h2>
            <p className={styles.sub}>Curated experiences designed around how you love to travel.</p>
          </div>
        </div>
          ...
          {TYPES.map((t, i) => (
            <div key={i} className={`${styles.card} ${i === 1 ? styles.offset : ''}`}>
              ...
              <div className={styles.overlay}>
                ...
                <button className={styles.vacBtn}>Explore →</button>
              </div>
            </div>
          ))}
        </div>
